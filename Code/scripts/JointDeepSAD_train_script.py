...
def main(seed_i):
    ...
    to zero. The AE is pretrained over 10 epochs in order to improve the initialization
    ...
    spliter = MURA_TrainValidTestSplitter(df_info.sample(n=100, random_state=11), train_frac=train_frac,

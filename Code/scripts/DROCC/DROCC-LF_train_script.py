...
def main(seed_i):
    ...
    want the network to learn the manifold of normal samples. Then the samples
    and adversarial samples are concatenated in a single batch that is then passed

...
from src.models.optim.CustomLosses import DeepSADLoss, DeepSADLossSubspace, MaskedMSELoss
...
class DeepSAD_Joint_trainer:
    ...
    """
    def __init__(self, space_repr, eta, lr=0.0001, n_epoch=150, n_epoch_pretrain=10, lr_milestone=(), batch_size=64,
                 weight_decay=1e-6, device='cuda', n_jobs_dataloader=0, print_batch_progress=False,
                 criterion_weight=(0.5,0.5), use_subspace=False):
        """
        ...
        self.SADLoss = DeepSADLossSubspace if use_subspace else DeepSADLoss

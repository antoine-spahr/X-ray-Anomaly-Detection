...
class joint_DMSAD:
    ...
    def train(self, dataset, valid_dataset=None, n_sphere_init=100, n_epoch=150,
              ...
              criterion_weight=(0.5, 0.5), batch_size=64, n_jobs_dataloader=0,
        ...
        OUTPUT
            |---- None
        """
        self.trainer = DMSAD_Joint_trainer(self.c, self.eta, n_sphere_init=n_sphere_init,
    ...
    def validate(self, dataset, batch_size=64, n_jobs_dataloader=0,
        ...
        if self.trainer is None:
            self.trainer = DMSAD_Joint_trainer(self.c, self.eta, batch_size=batch_size,
    ...
    def save_model(self, export_path):
        ...
        OUTPUT
            |---- None
        """
        torch.save({'c':self.c, 'net_dict':self.net.state_dict()}, export_path)
